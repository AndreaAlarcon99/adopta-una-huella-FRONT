      ...
      <div className="row">
        ...
        <div className="col-12 col-md-6 mt-md-5 m-5 m-md-0 text-center">
            <div id="containerDescription">
              ...
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic exercitationem itaque ullam ut aut sapiente cumque tempore illum voluptates qui! Harum qui neque deserunt quas voluptate dolorum. Nostrum, laboriosam nihil.</p>
              <button
                type="button"
              ...
              <div className="container"><h3>Soy un array de imagenes</h3></div>
            </div>
